export default {
  ...
  logs: {
    title: "ログ",
    subtitle: "システムリクエストログとトークン使用記録を確認",
    requestLogs: "リクエストログ",
    systemLogs: "システムログ",
    errorLogs: "エラーログ",
    accessLogs: "アクセスログ",
  ...
  tokens: {
    ...
    tokenDetail: "トークン詳細",
    estimatedCost: "推定コスト",
    basedOnPricing: "価格設定に基づく",
    totalRequests: "総リクエスト数",
    avgPerRequest: "リクエスト当たり平均",
    todayUsage: "今日の使用量",
    fromYesterday: "昨日から",
    input: "入力",
    output: "出力",
